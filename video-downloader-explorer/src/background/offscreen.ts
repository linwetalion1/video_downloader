...
// SW шлёт чанки (OFFSCREEN_SAVE_CHUNK, индексы последовательные), в конце —
// COMMIT с полным путём. Количество чанков заранее может быть неизвестно
// (стриминг) — собираем по индексам и проверяем отсутствие дыр.
